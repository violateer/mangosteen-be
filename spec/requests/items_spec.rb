...
RSpec.describe "Items", type: :request do
  ...
  describe "统计数据" do
    it "按天分组" do
      ...
      Item.create! amount: 10000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 20000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 30000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 20), user_id: user.id
      Item.create! amount: 15000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 20), user_id: user.id
      Item.create! amount: 22000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 19), user_id: user.id
      Item.create! amount: 18000, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 19), user_id: user.id
      get "/api/v1/items/summary", params: {
                                     happend_after: "2018-01-01",
                                     happend_before: "2019-01-01",
                                     kind: "expenses",
                                     group_by: "happen_at",
      ...
      expect(json["groups"][0]["amount"]).to eq 30000
      expect(json["groups"][1]["happen_at"]).to eq "2018-06-19"
      expect(json["groups"][1]["amount"]).to eq 40000
      expect(json["groups"][2]["happen_at"]).to eq "2018-06-20"
      expect(json["groups"][2]["amount"]).to eq 45000
      expect(json["total"]).to eq 115000
    end
    ...
    it "按标签ID分组" do
      ...
      Item.create! amount: 10000, kind: "expenses", tags_id: [tag1.id, tag2.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 20000, kind: "expenses", tags_id: [tag2.id, tag3.id], happen_at: Time.new(2018, 6, 20), user_id: user.id
      Item.create! amount: 30000, kind: "expenses", tags_id: [tag3.id, tag1.id], happen_at: Time.new(2018, 6, 19), user_id: user.id
      get "/api/v1/items/summary", params: {
                                     happend_after: "2018-01-01",
                                     happend_before: "2019-01-01",
                                     kind: "expenses",
      ...
      expect(json["groups"][0]["amount"]).to eq 50000
