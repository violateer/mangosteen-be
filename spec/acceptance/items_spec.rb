...
resource "账目" do
  ...
  get "/api/v1/items/summary" do
    ...
    example "统计信息（按happen_at分组）" do
      ...
      Item.create! amount: 100, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 200, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 100, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 20), user_id: user.id
      Item.create! amount: 200, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 20), user_id: user.id
      Item.create! amount: 100, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 19), user_id: user.id
      Item.create! amount: 200, kind: "expenses", tags_id: [tag.id], happen_at: Time.new(2018, 6, 19), user_id: user.id
    ...
    example "统计信息（按tag_id分组）" do
      ...
      Item.create! amount: 100, kind: "expenses", tags_id: [tag1.id, tag2.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 200, kind: "expenses", tags_id: [tag2.id, tag3.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
      Item.create! amount: 300, kind: "expenses", tags_id: [tag3.id, tag1.id], happen_at: Time.new(2018, 6, 18), user_id: user.id
